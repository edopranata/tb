        ...
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body table-responsive p-0">
                    ...
                    @endif
                    <button wire:click="addNew()" class="btn tw-bg-slate-900 tw-text-slate-300 hover:tw-bg-slate-700 hover:tw-text-slate-100 tw-font-bold mx-2 my-2">Buat kategori baru </button>
